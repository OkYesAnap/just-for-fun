...
export const chatPages = {
    ...
    "Prompt": createDefaultParams(`You create prompts for a video neural network that generates a short video clip from a photo.  
    You must format the prompt itself in Markdown as a code block with the language name \`prompt\`.  
    The prompt must be in English.  
    You describe only actions; you should not describe what will be depicted, because you are making a video from a photo.  
    ...
    In other words, you clearly describe all the actions, and then, if necessary, the camera movements.  
    If I do not mention the camera, you should not mention it either.`),
};
